...
const STEPS = Object.freeze([
  ...
  { id: "name", npm: "name", cmd: ["name-words-lzw.js", "worksheet"], phase: "pipeline", order: 2,
    ...
    reads: ["<CORPUS>/sen/catalog/generators-lzw.json"], writes: ["name-words-lzw-worksheet.json (engine tree, gitignored — see README)"],
    expensive: false, destructive: false, needs: ["generators-lzw"] },
  ...
  { id: "render", npm: "render", cmd: ["write-en-files.js"], phase: "pipeline", order: 3,
    ...
    reads: ["<CORPUS>/sen/catalog/generators-lzw.json"], writes: ["<CORPUS>/sen/files/**/*.en"],
  ...
  { id: "measure", npm: "measure", cmd: ["measure-english.js"], phase: "pipeline", order: 4,
    ...
    reads: ["<CORPUS>/sen/files/**/*.en"], writes: [],
    expensive: false, destructive: false, needs: ["generators-lzw"] },
  ...
  { id: "measure:uncollapsed", npm: "measure:uncollapsed", cmd: ["measure-uncollapsed.js"], phase: "measure",
    ...
    reads: ["<CORPUS>/sen/catalog/"], writes: ["<CORPUS>/.cache/spec-derived/uncollapsed.json"],
    expensive: true, destructive: false, needs: ["generators-lzw"] },
